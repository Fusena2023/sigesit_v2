...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="users-table-produk" width="100%">
        ...
        <script>
            $(function() {
                $('#users-table-produk').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('admin.datatables.getdatatiketlayananpasut') }}",
                    columns: [{
                            data: 'no_tiket',
                            name: 'no_tiket',
                            orderable: false
        ...
        <script type="text/javascript">
            function lihat(no_tiket, tanggal, nama, created_at, updated_at) {
                ...
                Swal.fire({
                    ...
                    html: '<div style="text-align:left;">' +
                        ...
                        '<th colspan="2"><center>Layanan : <br> Tiket Layanan Produk</center></th>' +
                        '</tr>' +
                        '</tbody>' +
                        '</table>' +
                        '<br>' +
            ...
            function tutup(id_tiket, no_tiket, tanggal, mulai, selesai, nama, created_at, updated_at) {
                var ico = '{{url("assets/digilab/images/ico.png")}}';
                Swal.fire({
                    ...
                    html: '<div style="text-align:left;">' +
                        ...
                        '<tr rowspan="2">' +
                        '<th colspan="2" style="width:50%;border-right: 1px solid black;"><center>No. Tiket :<br>' + no_tiket + '</center></th>' +
                        '<th colspan="2"><center>Layanan Produk : <br>Pasang Surut</center></th>' +
                        '</tr>' +
                        '</tbody>' +
                        '</table>' +
                        '<br>' +
                        ...
                        '<form method="POST" name="formcloselayananjasa" action="{{ route("admin.tutuptiketlayananjasa") }}" role="form">@csrf<input name="id" type="hidden" value="' + id_tiket + '"></form>' +
                        '</div>' +
                        '</font>' +
                        '</div>',
                    imageUrl: ico,
            ...
            function edit(id_tiket) {
                var html = '<form method="POST" id="formeditmjl" action="{{ route("admin.update_status.layanan_jasa_nol") }}" enctype="multipart/form-data" role="form">' +
                    ...
                    '<input type="hidden" name="id_data" class="form-control" value="' + id_tiket + '">' +
                    '</div>' +
                    '</form>';
