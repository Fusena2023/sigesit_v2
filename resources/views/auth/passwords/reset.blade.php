                        ...
                        <div id="home" class="tab-pane fade in show active">
                            <form class="login100-form" method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="wrap-input100 validate-input" data-validate="Enter Email" style="border-bottom:2px solid rgb(21 50 92)">
                                    <input type="email" class="input100{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="email" value="{{ $email ?? old('email') }}" readonly style="width:100%;">
                                    @if ($errors->has('email'))
                                ...
                                <div class="wrap-input100 validate-input" data-validate="Enter Password" style="border-bottom:2px solid rgb(21 50 92)">
                                 ...
                                 <input type="checkbox" id="showPass">Lihat Password
        
                                <div class="wrap-input100 validate-input" data-validate="Enter Password" style="border-bottom:2px solid rgb(21 50 92)">
                                    <input type="password" class="input100" name="password_confirmation" id="password-confirm" placeholder="{{ __('Confirm Password') }}" required style="width:100%;">
                                    <span class="focus-input100" data-placeholder="&#xf207;"></span>
                                </div>
                                
                            <input type="checkbox" id="showPass_confirm">Lihat Password
...
<!--===============================================================================================-->
    ...
    <script type="text/javascript">
        $('#showPass').on('click', function() {
            ...
            $('#showPass_confirm').on('click', function() {
