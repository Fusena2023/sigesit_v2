...
<body>
            ...
            <div class="wrap-login100" style="padding:30px 55px 37px 55px!important;background:white;">
                ...
                <div class="tab-content">
                    <div id="menu1" class="tab-pane fade in show active">
                        <form class="login100-form" id="login-user-internal-form" role="form" method="POST" action="{{url('login-internal') }}">
                            {{ csrf_field() }}
    ...
    <script>
        function change() {
            ...
            var x = document.getElementById('password_internal').type;

            //membuat if kondisi, jika tipe x adalah password maka jalankan perintah di bawahnya
            if (x == 'password') {

                //ubah form input password menjadi text
                document.getElementById('password_internal').type = 'text';
                ...
                //ubah form input password menjadi text
                document.getElementById('password_internal').type = 'password';
    ...
    <script type="text/javascript">
        $('#showPass').on('click', function() {
            var passInput = $("#password_internal");
