    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
      <div class="container">
        <img src="{{ url('assets/digilab/images/ico.png')}}" style="width: 70px" {{-- style="width:80%;height:80%;" --}}>&nbsp;&nbsp;
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav nav ml-auto">
            ...
            {{-- <li class="nav-item" style="border-color: rgb(254, 166, 33); border:none;">
              <a href="#projects-section" class="nav-link"><span>Layanan Publik</span></a>
            </li> --}}
            <li class="nav-item" style="border-color: rgb(254, 166, 33); border:none;">
            ...
            <!-- <li class="nav-item" style="border-color: rgb(254, 166, 33); border:none;">
              <a href="#" class="nav-link"><span>Pengaduan</span></a>
            </li> -->
            <li class="nav-item" style="border-color: rgb(254, 166, 33); border:none;">
            ...
            <li class="nav-item" style="border-color: rgb(254, 166, 33); border:none;">
              <a href="#skm-section" class="nav-link"><span>Hasil SKM</span></a>
            </li>
            @endif
            <li class="nav-item" style="border-color: rgb(254, 166, 33); border:none;">
            ...
            {{-- <li class="nav-item" style="border-color: rgba(28,110,164,0.51);">
              <!-- <a onclick="lihatauth()" class="nav-link"><span>{{ Auth::guard('pengguna')->user()->nama }}</span></a> -->
            </li> --}}
            ...
            <!-- <li class="nav-item" style="border-color: rgb(167, 167, 175);">
              <a href="{{ route('pengguna.auth.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form-internal').submit();" class="nav-link"><span>Keluar</span></a>
