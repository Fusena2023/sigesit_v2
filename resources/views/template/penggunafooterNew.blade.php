...
<footer class="ftco-footer ftco-section" style="background-color: #100674;">
    <div class="container-2">
        <div class="row">
            @foreach($mastertentangs as $mt)
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2" style="color:white ;">Kontak Kami</h2>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2" style="color:white ;">APLIKASI PELAYANAN TERPADU INFORMASI GEOSPASIAL (PTIG)</h2>
                    @foreach($mastertentangs as $mt)
                    <p>{{$mt->deskripsi}}</p>
                    @endforeach
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    <h2 class="ftco-heading-2" style="color:white ;">Layanan Publik</h2>
                    <ul class="list-unstyled">
                        <li><a href="#services-section"></span>Layanan Jasa Konsultasi</a></li>
                        <li><a href="#services-section2"></span>Layanan Produk Daring</a></li>
                        <li><a href="#services-section3"></span>Layanan Produk IG Nol Rupiah</a></li>
                        <li><a href="#"></span>Layanan Produk IG, Jasa dan Diklat Berbayar</a></li>
                        <li><a href="#">Layanan Pembayaran Ke Kas Negara</a></li>
                    </ul>
                </div>
            </div>
        </div>
        {{-- <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                    ...
                    </script> Pusat Terpadu Informasi Geospasial
                    <!--| This template is modified from <a href="https://colorlib.com" target="_blank">Colorlib</a>-->
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div> --}}
...
<div id="ftco-loader" class="show fullscreen"><svg class="circular" width="48px" height="48px">
        ...
        <circle class="path" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke-miterlimit="10" stroke="#0f88bf" /></svg></div>
